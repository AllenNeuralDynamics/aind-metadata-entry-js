...
var includes = _interopDefault(require('core-js-pure/es/array/includes'));
var ReactIs = require('react-is');
var mergeAllOf = _interopDefault(require('json-schema-merge-allof'));
var fill = _interopDefault(require('core-js-pure/features/array/fill'));
var union = _interopDefault(require('lodash/union'));
var jsonpointer = _interopDefault(require('jsonpointer'));
...
function IconButton(props) {
  ...
  }, otherProps), /*#__PURE__*/React__default.createElement("i", {
...
function getWidget(schema, widget, registeredWidgets) {
  ...
  function mergeOptions(Widget) {
    ...
    if (!Widget.MergedWidget) {
      ...
      Widget.MergedWidget = function (_ref) {
        ...
        return /*#__PURE__*/React__default.createElement(Widget, _extends({
  ...
  if (typeof widget === "function" || ReactIs.isForwardRef(React__default.createElement(widget)) || ReactIs.isMemo(widget)) {
...
function DefaultArrayItem(props) {
  ...
  }, props.children), props.hasToolbar && /*#__PURE__*/React__default.createElement("div", {
...
var ArrayField = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderNormalArray = function renderNormalArray() {
    ...
    return /*#__PURE__*/React__default.createElement(Component, arrayProps);
  };
  ...
  _proto.renderFixedArray = function renderFixedArray() {
    ...
    return /*#__PURE__*/React__default.createElement(Template, arrayProps);
  };
  ...
  _proto.renderArrayFieldItem = function renderArrayFieldItem(props) {
    ...
    return {
      children: /*#__PURE__*/React__default.createElement(SchemaField, {
        index: index,
        schema: itemSchema,
...
var AnyOfField = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      registry: registry
    }, uiOptions))), option !== null && /*#__PURE__*/React__default.createElement(_SchemaField, {
      schema: optionSchema,
      uiSchema: uiSchema,
      errorSchema: errorSchema,
      idSchema: idSchema,
...
var NumberField = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(StringField, _extends({}, props, {
      formData: value,
...
function DefaultObjectFieldTemplate(props) {
  ...
  return /*#__PURE__*/React__default.createElement("fieldset", {
    id: props.idSchema.$id
  }, (props.uiSchema["ui:title"] || props.title) && /*#__PURE__*/React__default.createElement(TitleField, {
    id: props.idSchema.$id + "__title",
    title: props.title || props.uiSchema["ui:title"],
    required: props.required,
    formContext: props.formContext
  }), props.description && /*#__PURE__*/React__default.createElement(DescriptionField, {
    id: props.idSchema.$id + "__description",
    description: props.description,
    formContext: props.formContext
  }), props.properties.map(function (prop) {
    return prop.content;
  }), canExpand(props.schema, props.uiSchema, props.formData) && /*#__PURE__*/React__default.createElement(AddButton, {
...
var ObjectField = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    try {
      ...
      }, "Invalid ", name || "root", " object field configuration:", /*#__PURE__*/React__default.createElement("em", null, err.message), "."), /*#__PURE__*/React__default.createElement("pre", null, JSON.stringify(schema)));
    }
    ...
    var templateProps = {
      ...
      properties: orderedProperties.map(function (name) {
        ...
        return {
          content: /*#__PURE__*/React__default.createElement(SchemaField, {
            key: name,
            name: name,
    ...
    return /*#__PURE__*/React__default.createElement(Template, _extends({}, templateProps, {
...
function DefaultTemplate(props) {
  ...
  return /*#__PURE__*/React__default.createElement(WrapIfAdditional, props, displayLabel && /*#__PURE__*/React__default.createElement(Label, {
    label: label,
    required: required,
    id: id
...
function WrapIfAdditional(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    required: required,
    id: id + "-key"
  }), /*#__PURE__*/React__default.createElement(LabelInput, {
    label: label,
    required: required,
    id: id + "-key",
...
function SchemaFieldRender(props) {
  ...
  var field = /*#__PURE__*/React__default.createElement(FieldComponent, _extends({}, props, {
    idSchema: idSchema,
    schema: schema,
  ...
  var fieldProps = {
    ...
    help: /*#__PURE__*/React__default.createElement(Help, {
      id: id + "__help",
      help: help
    }),
    rawHelp: typeof help === "string" ? help : undefined,
    errors: hideError ? undefined : /*#__PURE__*/React__default.createElement(ErrorList, {
      errors: errors
    }),
  ...
  return /*#__PURE__*/React__default.createElement(FieldTemplate, fieldProps, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, field, schema.anyOf && !isSelect(schema) && /*#__PURE__*/React__default.createElement(_AnyOfField, {
    disabled: disabled,
    readonly: readonly,
    hideError: hideError,
    errorSchema: errorSchema,
    ...
    schema: schema,
    uiSchema: uiSchema
  }), schema.oneOf && !isSelect(schema) && /*#__PURE__*/React__default.createElement(_OneOfField, {
    disabled: disabled,
    readonly: readonly,
    hideError: hideError,
    errorSchema: errorSchema,
...
function UnsupportedField(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement("p", null, "Unsupported field schema", idSchema && idSchema.$id && /*#__PURE__*/React__default.createElement("span", null, " for", " field ", /*#__PURE__*/React__default.createElement("code", null, idSchema.$id)), reason && /*#__PURE__*/React__default.createElement("em", null, ": ", reason), "."), schema && /*#__PURE__*/React__default.createElement("pre", null, JSON.stringify(schema, null, 2)));
}
...
var AltDateWidget = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("ul", {
      ...
      return /*#__PURE__*/React__default.createElement("li", {
        key: i
      }, /*#__PURE__*/React__default.createElement(DateElement, _extends({
        rootId: id,
    ...
    }), (options.hideNowButton !== "undefined" ? !options.hideNowButton : true) && /*#__PURE__*/React__default.createElement("li", null, /*#__PURE__*/React__default.createElement("a", {
      href: "#",
      className: "btn btn-info btn-now",
      onClick: this.setNow
    }, "Now")), (options.hideClearButton !== "undefined" ? !options.hideClearButton : true) && /*#__PURE__*/React__default.createElement("li", null, /*#__PURE__*/React__default.createElement("a", {
      href: "#",
...
function BaseInput(props) {
  ...
  })), schema.examples ? /*#__PURE__*/React__default.createElement("datalist", {
...
function CheckboxWidget(props) {
  ...
  }, schema.description && /*#__PURE__*/React__default.createElement(DescriptionField, {
...
function CheckboxesWidget(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    var checkbox = /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement("input", {
      type: "checkbox",
      id: id + "_" + index,
      checked: checked,
    ...
    }), /*#__PURE__*/React__default.createElement("span", null, option.label));
    return inline ? /*#__PURE__*/React__default.createElement("label", {
      key: index,
      className: "checkbox-inline " + disabledCls
    }, checkbox) : /*#__PURE__*/React__default.createElement("div", {
      key: index,
      className: "checkbox " + disabledCls
    }, /*#__PURE__*/React__default.createElement("label", null, checkbox));
  }));
}
...
function FilesInfo(props) {
  ...
  return /*#__PURE__*/React__default.createElement("ul", {
    ...
    return /*#__PURE__*/React__default.createElement("li", {
      key: key
    }, /*#__PURE__*/React__default.createElement("strong", null, name), " (", type, ", ", size, " bytes)");
  }));
}
...
var FileWidget = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("p", null, /*#__PURE__*/React__default.createElement("input", {
    ...
    })), /*#__PURE__*/React__default.createElement(FilesInfo, {
      filesInfo: filesInfo
    }));
  };
...
function RadioWidget(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    var itemDisabled = enumDisabled && enumDisabled.indexOf(option.value) != -1;
    var disabledCls = disabled || itemDisabled || readonly ? "disabled" : "";
    var radio = /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement("input", {
      type: "radio",
      checked: checked,
      name: name,
      required: required,
    ...
    }, /*#__PURE__*/React__default.createElement("label", null, radio));
  }));
}
...
function RangeWidget(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(BaseInput, _extends({
    type: "range"
  }, props, rangeSpec(schema))), /*#__PURE__*/React__default.createElement("span", {
...
function SelectWidget(props) {
  ...
  }, !multiple && schema["default"] === undefined && /*#__PURE__*/React__default.createElement("option", {
    value: ""
...
function TextWidget(props) {
  var BaseInput = props.registry.widgets.BaseInput;
  return /*#__PURE__*/React__default.createElement(BaseInput, props);
}
...
function SubmitButton(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, !norender && /*#__PURE__*/React__default.createElement("button", _extends({
    type: "submit"
  }, submitButtonProps, {
...
function ErrorList$1(props) {
  ...
  }, "Errors")), /*#__PURE__*/React__default.createElement("ul", {
...
var Form = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderErrors = function renderErrors() {
    ...
    if (errors.length && showErrorList != false) {
      return /*#__PURE__*/React__default.createElement(ErrorList, {
        errors: errors,
        errorSchema: errorSchema,
        schema: schema,
        uiSchema: uiSchema,
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(FormTag, {
    ...
    }, this.renderErrors(), /*#__PURE__*/React__default.createElement(_SchemaField, {
      schema: schema,
      uiSchema: uiSchema,
      errorSchema: errorSchema,
      idSchema: idSchema,
      ...
      disabled: disabled,
      readonly: readonly
    }), children ? children : /*#__PURE__*/React__default.createElement(SubmitButton, {
      uiSchema: uiSchema
    }));
  };
...
function withTheme(themeProps) {
  return React.forwardRef(function (_ref, ref) {
    ...
    return /*#__PURE__*/React__default.createElement(Form, _extends({}, themeProps, directProps, {
      fields: fields,
      widgets: widgets,
      ref: ref
    }));
